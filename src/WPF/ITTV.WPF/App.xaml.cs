...
namespace ITTV.WPF
{
    public partial class App
    {
        ...
        private void ReOpenApp(UnhandledExceptionEventArgs args = null)
        {
            if (args != null)
            {
                var e = (Exception) args.ExceptionObject;
                Log.Logger.Fatal(e, "ReOpenApp, Fatal exception");
            }
        ...
        private void ConfigureReOpenApp()
        {
            ...
            if (!settings.IsAdminMode)
            {
                ...
                AppDomain.CurrentDomain.UnhandledException += (_,e) => ReOpenApp(e);
            }
        }
    }
}